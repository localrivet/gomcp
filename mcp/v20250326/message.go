...
type BaseMessage struct {
	...
	Version  string          `json:"version"` // Added version field for v20250326
...
const (
	...
	RequestTypeStream        RequestType = "stream" // Added for v20250326
)
...
type ToolCallRequest struct {
	...
	Stream    bool            `json:"stream,omitempty"` // Added for v20250326
}
...
// StreamRequest represents a stream request for v20250326
...
const (
	...
	ResponseTypeStreamUpdate    ResponseType = "stream_update" // Added for v20250326
)
...
type ToolResultResponse struct {
	...
	Streaming bool        `json:"streaming,omitempty"` // Added for v20250326
}
...
// StreamUpdateResponse represents a stream update response for v20250326
...
const (
	...
	ErrorCodeStreamNotFound      ErrorCode = "stream_not_found"   // Added for v20250326
	ErrorCodeStreamUnavailable   ErrorCode = "stream_unavailable" // Added for v20250326
...
type ErrorResponse struct {
	...
	RequestID string    `json:"request_id,omitempty"` // Added for v20250326
}
...
// StructuredContent represents a structured content block for v20250326
