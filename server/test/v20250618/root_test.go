// Package v20250618 contains tests specifically for the 2025-06-18 version of the MCP specification
package v20250618
...
// TestRootHandlingV20250618 tests root path handling against 2025-06-18 specification
func TestRootHandlingV20250618(t *testing.T) {
	// Create a server
	srv := server.NewServer("test-server-v20250618")

	// Set some root paths - this uses the 2025-06-18 specification's concept of filesystem roots
	...
	// V20250618 specification requires respecting filesystem roots
