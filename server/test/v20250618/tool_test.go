...
// TestToolExecutionV20250618 tests tool execution against 2025-06-18 specification
func TestToolExecutionV20250618(t *testing.T) {
	// Create a server
	...
	srv.Tool("echo", "Echo back the input", func(ctx *server.Context, args interface{}) (interface{}, error) {
		...
		"compatibility": []string{"2024-11-05", "2025-03-26", "2025-06-18"},
		"securityLevel": "high",
	})
