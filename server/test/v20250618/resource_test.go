...
// TestResourceHandlingV20250618 tests resource handling against 2025-06-18 specification
func TestResourceHandlingV20250618(t *testing.T) {
	// Create a server
	srv := server.NewServer("test-server-v20250618")
	...
	srv.Resource("/test", "A simple test resource for draft spec", func(ctx *server.Context, args interface{}) (interface{}, error) {
		...
		return map[string]interface{}{
			...
			"metadata": map[string]interface{}{
				"version":   "2025-06-18",
				"tags":      []string{"test", "example", "2025-06-18"},
				"generated": true,
			},
		}, nil
	})
	...
	t.Run("MixedContentResource", func(t *testing.T) {
		...
		// Use HandleMessageWithVersion to ensure 2025-06-18 version
		responseBytes, err := server.HandleMessageWithVersion(srv, requestJSON, "2025-06-18")
		if err != nil {
		...
		// Verify the response structure according to 2025-06-18 specification
		validateV20250618ResourceResponse(t, response.Result)
		...
		if metadata["version"] != "2025-06-18" {
...
func validateV20250618ResourceResponse(t *testing.T, result map[string]interface{}) {
	t.Helper()

	// V20250618 spec requires "contents" field, not "content"
	if _, hasContent := result["content"]; hasContent {
		t.Errorf("Response has 'content' field which is not part of draft spec, should use 'contents'")
	}
