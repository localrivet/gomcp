...
func executeFileSystem(ctx context.Context, progressToken *protocol.ProgressToken, args map[string]interface{}) (content []protocol.Content, isError bool) { // Use protocol types
