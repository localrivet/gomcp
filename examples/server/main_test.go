...
func testEchoHandler(ctx context.Context, pt *protocol.ProgressToken, args map[string]interface{}) ([]protocol.Content, bool) {
...
func testCalculatorHandler(ctx context.Context, pt *protocol.ProgressToken, args map[string]interface{}) ([]protocol.Content, bool) {
...
func testFilesystemHandler(ctx context.Context, pt *protocol.ProgressToken, args map[string]interface{}) ([]protocol.Content, bool) {
