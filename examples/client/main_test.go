...
func testFilesystemHandler(ctx context.Context, pt *mcp.ProgressToken, args map[string]interface{}) ([]mcp.Content, bool) {
	...
	case "list_files":
		if path == "." {
			return []mcp.Content{mcp.TextContent{Type: "text", Text: `{"files":[]}`}}, false
	...
	case "write_file":
		if path == "../outside_sandbox.txt" {
			return []mcp.Content{mcp.TextContent{Type: "text", Text: "path '../outside_sandbox.txt' attempts to escape the sandbox"}}, isErrTrue
		}
	...
	case "read_file":
		if path == "test_dir/my_file.txt" {
			return []mcp.Content{mcp.TextContent{Type: "text", Text: "This is the content of the test file.\nIt has multiple lines."}}, false
		} else if path == "non_existent_file.txt" {
			return []mcp.Content{mcp.TextContent{Type: "text", Text: "File not found at path 'non_existent_file.txt'"}}, isErrTrue
		}
	}
	return []mcp.Content{mcp.TextContent{Type: "text", Text: fmt.Sprintf("Unhandled filesystem operation/path: %s %s", op, path)}}, isErrTrue
}
...
func TestExampleClientLogic(t *testing.T) {
	...
	go func() {
		...
		if !idOk || method != mcp.MethodInitialize {
		...
		initResult := mcp.InitializeResult{
			...
			Capabilities: mcp.ServerCapabilities{ // Advertise capabilities matching dummy tools
				Tools: &struct {
		...
		method, _ = msg["method"].(string)
		_, idExists := msg["id"]
		if idExists || method != mcp.MethodInitialized {
		...
		reqID, idOk = msg["id"]
		method, _ = msg["method"].(string)
		if !idOk || method != mcp.MethodListTools {
		...
		tools := []mcp.Tool{testEchoTool, testCalculatorTool, testFileSystemTool}
		listToolsResp := mcp.ListToolsResult{Tools: tools}
		...
		if !idOk || method != mcp.MethodCallTool || !paramsOk {
		...
		echoResp := mcp.CallToolResult{Content: []mcp.Content{mcp.TextContent{Type: "text", Text: ctReqEcho.Arguments["message"].(string)}}}
		...
		var ctReqCalc1 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqCalc1); err != nil || ctReqCalc1.Name != "calculator" {
		...
		calcResult1 := mcp.CallToolResult{Content: calcResp1, IsError: BoolPtr(isErr1)}             // Use local BoolPtr
		...
		var ctReqCalc2 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqCalc2); err != nil || ctReqCalc2.Name != "calculator" {
		...
		calcResult2 := mcp.CallToolResult{Content: calcResp2, IsError: BoolPtr(isErr2)}             // Use local BoolPtr
		...
		var ctReqCalc3 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqCalc3); err != nil || ctReqCalc3.Name != "calculator" {
		...
		calcResult3 := mcp.CallToolResult{Content: calcResp3, IsError: BoolPtr(isErr3)}             // Use local BoolPtr
		...
		var ctReqFs1 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqFs1); err != nil || ctReqFs1.Name != "filesystem" {
		...
		fsResult1 := mcp.CallToolResult{Content: fsResp1, IsError: BoolPtr(fsIsErr1)} // Use local BoolPtr
		...
		var ctReqFs2 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqFs2); err != nil || ctReqFs2.Name != "filesystem" {
		...
		fsResult2 := mcp.CallToolResult{Content: fsResp2, IsError: BoolPtr(fsIsErr2)} // Use local BoolPtr
		...
		var ctReqFs3 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqFs3); err != nil || ctReqFs3.Name != "filesystem" {
		...
		fsResult3 := mcp.CallToolResult{Content: fsResp3, IsError: BoolPtr(fsIsErr3)} // Use local BoolPtr
		...
		var ctReqFs4 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqFs4); err != nil || ctReqFs4.Name != "filesystem" {
		...
		fsResult4 := mcp.CallToolResult{Content: fsResp4, IsError: BoolPtr(fsIsErr4)} // Use local BoolPtr
		...
		var ctReqFs5 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqFs5); err != nil || ctReqFs5.Name != "filesystem" {
		...
		fsResult5 := mcp.CallToolResult{Content: fsResp5, IsError: BoolPtr(fsIsErr5)} // Use local BoolPtr
		...
		var ctReqFs6 mcp.CallToolParams
		if err := mcp.UnmarshalPayload(paramsRaw, &ctReqFs6); err != nil || ctReqFs6.Name != "filesystem" {
		...
		fsResult6 := mcp.CallToolResult{Content: fsResp6, IsError: BoolPtr(fsIsErr6)} // Use local BoolPtr
